...
async function seedGames() {
  ...
  const games = [
    ...
    { stage:'group', group_name:'J', home_team:'Argentina',       away_team:'Argélia',        match_time:'2026-06-16T22:00:00-03:00', cidade:'Kansas City' },
    ...
    { stage:'group', group_name:'F', home_team:'Tunísia',         away_team:'Japão',          match_time:'2026-06-20T23:00:00-03:00', cidade:'Monterrey' },
...
async function migrateGames() {
  const fixes = [
    ...
    { sql: "UPDATE games SET match_time = '2026-06-26T21:00:00-03:00' WHERE home_team = 'Cabo Verde' AND away_team = 'Arábia Saudita' AND match_time != '2026-06-26T21:00:00-03:00'" },
    { sql: "UPDATE games SET match_time = '2026-06-26T21:00:00-03:00' WHERE home_team = 'Uruguai' AND away_team = 'Espanha' AND match_time != '2026-06-26T21:00:00-03:00'" },
    { sql: "UPDATE games SET match_time = '2026-06-27T00:00:00-03:00' WHERE home_team = 'Egito' AND away_team = 'Irã' AND match_time != '2026-06-27T00:00:00-03:00'" },
    { sql: "UPDATE games SET match_time = '2026-06-27T00:00:00-03:00' WHERE home_team = 'Nova Zelândia' AND away_team = 'Bélgica' AND match_time != '2026-06-27T00:00:00-03:00'" },
    { sql: "UPDATE games SET match_time = '2026-06-27T23:00:00-03:00' WHERE home_team = 'Argélia' AND away_team = 'Áustria' AND match_time != '2026-06-27T23:00:00-03:00'" },
    { sql: "UPDATE games SET match_time = '2026-06-27T23:00:00-03:00' WHERE home_team = 'Jordânia' AND away_team = 'Argentina' AND match_time != '2026-06-27T23:00:00-03:00'" },
  ];
